...
function CandidateListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CandidateInterface[]>(
    ...
    () =>
      getCandidates({
        relations: ['job_posting', 'referral.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('referral', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>referral</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('referral', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.referral}</Td>
                    )}
                    <Td>
